...
data "aws_iam_policy_document" "gitaction_assume_role_document" {
  statement {
    ...
    condition {
      ...
      values = [
        "repo:sehoon99/springboot-sample:*",
      ]
    }
...
#     ]
#     resources = [
#       aws_iam_role.demo_bhunyapne2_task.arn,
#       aws_iam_role.demo_bhunyapne2_task_exec.arn
#     ]
#   }
#   statement {
#     sid    = "DeployService"
...
#     ]
#     resources = [
#       data.terraform_remote_state.demo_bhunyapne2.outputs.ecs_service_arn,
